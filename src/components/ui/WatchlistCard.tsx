...
export default function WatchlistCard(props: FilmCardProps) {
  ...
  return (
    <div
      ...
      className="group relative aspect-[2/3] w-full cursor-pointer rounded-lg"
    >
      <div onPointerEnter={open} onPointerLeave={scheduleClose} className="h-full w-full overflow-hidden rounded-lg">
        <img src={props.content.poster_url} alt={props.content.title} className="h-full w-full rounded-lg object-cover" />
          ...
          <div className="h-[180px] bg-background-paper p-7.5">
            <div className="mb-4 flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={() => handleToggleWatchlist(props.content) }
